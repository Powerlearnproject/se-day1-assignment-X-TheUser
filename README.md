...
As discussed, the waterfall methodology follows a rigid process. So each stage (requirements gathering, design, development, testing, deployment) must be concluded before proceeding to the next phase. The agile method follows an iterative development. The process is broken down into smaller 'sprints' or stages, allowing constant commentary and enhancement. The waterfall method restricts feedback loops. Therefore, consumer commentary is gathered when the project is concluded. The agile method allows constant consumer participation. This means that the method allows the consumers to constantly engage in gathering commentary and modifying the project. 
...
The quality assurance engineer plans, implements and leads tests to make sure that the software connects with the quality standards by finding and stating issues. They thus work closely with the software developers to correct the problems and observe the whole project quality throughout the software development cycle. The quality assurance engineer's main responsibilities include creating test plans, composing test cases, implementing tests, recording issues, and collaborating with the development team to preserve high-quality software.

The project manager is integral in managing the project and crucial to the completion of the software project. Project managers are responsible for composing the project proposition, forecasting the project's cost estimations, creating a timetable, predicting the staff that will be needed for the project, software procedure customisation, observing and supervising the project, version control management, loss prevention, managerial record writing, addressing, and communicate with clients.
...
Security: Software engineers are in danger of cyber-terrorists who want to compromise information. 

Strategies: Strategies to overcome the security challenge include embracing safe coding exercises, running constant security inspections, executing danger tailoring, putting importance on security consciousness education for developers, merging security right through the software development cycle, using automatic security testing, and constantly tracking systems for susceptibilities and possible dangers.

Technological change: New programming dialects, structures, and utilities are regularly appearing.

Strategies: Strategies to overcome technological changes include embracing agile methods, putting importance on constant learning, promoting partnership and communication between the different departments, vigorously assessing new technologies, encouraging a culture of flexibility, and devoting to upgrading programs to stay on trend with developing instruments and structures.

Changing requirements: Key players frequently notice that they require new characteristics or customisations to live practicality as a project advances.

Strategies: Strategies to overcome changing requirements involve embracing agile methods, executing a strong alteration control procedure, putting importance on needs, preserving open communication with key players, distinctly recording requirements, utilising styles such as refactoring, and constantly evaluating the influence of adjustments on the project sphere and schedule.

Debugging: Debugging huge source codes can be devastating. Debugging is laborious and tough. It needs an understanding of both the programming habits and program formation.

Strategies: Strategies to overcome debugging challenges involve comprehending the issue meticulously, using correction instruments such as breakpoint and variable inspection, generating the bug regularly, disintegrating compound problems into tiny parts, employing print statements to trace shifting values, using a methodical procedure such as 'divide and conquer', connecting with other developers via twin correction, and authorising version control to trace code adjustments. Whilst doing this concentration should be put on a distinct code framework and recording to help in recognising possible problems.

Technical Debt: Technical debt happens when faults and bypasses are taken in the course of the progress.

Strategies: Strategies to help in overcoming technical debt challenges involve putting importance on and recognising technical debt, constantly restructuring code, enacting coding qualities, embracing agile development exercises, integrating automatic testing, running rigorous code assessments, and vigorously observing code standard conventions to notice areas that may need enhancement and aggressively attend to a possible problem.

Explain the different types of testing (unit, integration, system, and acceptance) and their importance in software quality assurance.

Unit testing is the exercise of testing the compact testable bits of a software application, named units, on their own to confirm that each part operates as planned and works accurately individually, which assists in finding and correcting bugs in advance during the development process. The importance of unit testing is that it lets developers see and fix issues sooner in the development process, guiding towards enhanced code quality, refined serviceability, and escalated belief in the software by finding problems at the individual component magnitude before they rise into bigger issues, eventually lessening development costs and time used in debugging.

Integration testing is a procedure whereby numerous parts are merged and examined jointly to confirm how they connect and work as a reliable system, making sure that data moves accurately between different components of the software application. The importance of integration testing is that it averts possible problems that could surface when components are connected and utilised in unison by users. 
